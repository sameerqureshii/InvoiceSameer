...
export const invoiceSchema = z.object({
    invoiceName: z.string().min(1, "Invoice Name is required"), total: z.number().min(1, "1$ is minimum"),
    ...
    clientEmail: z.string().email("Invalid Email Addres"),

    clientAddress: z.string().min(1, "Client Addres is required"),
